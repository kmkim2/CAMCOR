...
path_write = "C:\\Users\\kmkim\\Downloads\\research\\craft-3.1.3\\concept-annotation\\GO_BP\\GO_BP+extensions\\GO_BP_extensions_parsed_hierarchy_200616.txt"
...
for count,(theid, thename) in enumerate(zip (GO_ids, GO_names,)):
    ...
    for theRelation in relations[count]:
        rel_toWrites.append("|".join(theRelation))
